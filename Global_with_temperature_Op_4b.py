...
Jnet2=[]
V=15*t0;
for T in np.arange (0.01,0.35,0.03):
    ...
    for x in range(0,10):
        ...
        with open("hilbert_errors1.txt", "w") as f:           
...
np.savetxt("Currents_with_Temperature_op.txt", real_data, fmt="%.9f")  # Adjust precision as needed
